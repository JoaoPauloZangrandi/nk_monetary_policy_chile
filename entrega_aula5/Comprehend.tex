...
($-0{,}67$). (Arquivos em \texttt{outputs/dynare/baseline/}.)
...
\begin{itemize}[nosep]
  \item Modelo \textbf{fechado e pequeno}; o Chile é uma economia \textbf{aberta} (faltam câmbio,
        cobre, termos de troca, fluxos de capital).
...
previsão nativa do Dynare (incondicional e condicional) das páginas 48--55. Tudo é reprodutível e
honesto quanto aos seus limites.
\end{resumo}
