...
% ===================================================================
\section{Extensões v2 --- correções de método e novos dados}
% ===================================================================
\textit{Quadros acrescentados depois (na seção de Análise Macro e nas conclusões); atualizam a
numeração da apresentação.}

\slide{v2}{Convergência à meta e Kalman}{1 min}
Dois ajustes importantes. Primeiro, o hiato do produto agora vem de um \textbf{filtro de Kalman}, não
do HP --- um modelo de componentes não observados que separa tendência e ciclo estatisticamente.
Segundo, e mais importante, re-centrei a inflação na \textbf{meta de 3\%}: antes o modelo revertia à
média histórica de 3,8\%; agora o estado estacionário é a própria meta, então a previsão converge para
3\% \emph{por construção}, como deve ser num regime de metas. A inflação projetada vai de 2,5\% a 3\%.

\slide{v2}{Núcleos da inflação}{1,5 min}
Quebrando o IPC por núcleo, fica claro quem empurrou o surto de 2021--23: a \textbf{energia} liderou,
com pico de 24\% ao ano, à frente da cheia (14\%), dos serviços (12\%) e do núcleo (11\%). A energia é
muito volátil; núcleo e serviços subiram menos, mas de forma persistente. Isso conversa com o modelo: a
energia é um \textbf{choque de custo}, e a persistência de núcleo e serviços é a \textbf{inércia} que a
curva de Phillips híbrida captura.

\slide{v2}{Atividade e mercado de trabalho}{1,5 min}
No mercado de trabalho montei um \textbf{spider chart} no estilo do FED de Atlanta: cada indicador em
percentil da sua história, atual vs pré-pandemia. O Chile está forte em emprego e participação, perto
de máximas, mas fraco em desemprego, ainda 8,7\%, e em atividade, com o hiato perto de zero. É um
retrato de mais gente trabalhando e, ao mesmo tempo, mais gente procurando emprego, sem
superaquecimento. Pela \textbf{lei de Okun}, o desemprego elevado é coerente com o hiato levemente
negativo.

\slide{v2}{Conclusões de política}{1 min}
Fechando: o diagnóstico é de inflação puxada por custo de energia, com inércia em serviços, numa
economia perto do potencial. As implicações: a convergência à meta de 3\% deve vir em cerca de um ano,
com o juro aliviando ao neutro; o gradualismo do Banco Central importa mais que a força da reação; é
preciso paciência com o último quilômetro da desinflação; e o risco-chave é a reação à inflação estar
perto do limite de 1, o que torna a ancoragem de expectativas o ponto crítico. Nada é recomendação
oficial --- é a leitura de um laboratório transparente.
